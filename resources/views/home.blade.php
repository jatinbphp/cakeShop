...
<section class="popular-items section-padding40">
    <div class="container">
        ...
        <div class="popular-active">
            <div class="row">
                <div class="col-xl-12 col-lg-8 col-md-10 col-sm-10">
                    <div class="rescalendar" id="my_calendar_calSize"></div>
                </div>
                <div class="col-xl-12 col-lg-8 col-md-10 col-sm-10">
                    <p>Times shown in Asia/Manila time</p>
...
<section class="popular-items section-padding40">
    <div class="container">
        ...
        <div class="popular-active">
            <div class="row">
                <div class="col-xl-12 col-lg-8 col-md-10 col-sm-10">
                    <input type="text" name="" placeholder="coco@gmail.com">
                    <p><input type="checkbox" name="">I'd like to receive shop offers and updates through email
                    </p></br>
                    <button>Next</button>
                </div>
            </div>
...
<section class="popular-items section-padding40">
    <div class="container">
        ...
        <div class="popular-active">
            <div class="row">
                <div class="col-xl-12 col-lg-8 col-md-10 col-sm-10">
                    <input type="text" name="" placeholder="081234 56789">
                    <button>Next</button>
                </div>
            </div>
        </div>
