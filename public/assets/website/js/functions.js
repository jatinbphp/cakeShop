...
function Toggle(){
    ...
    window.SEMICOLON_togglesInit = function( $toggleEl ){
        ...
        $toggleEl.each( function(){
            ...
            if( elState != 'open' ){
                element.children('.toggle-content1').hide();
            } else {
                element.addClass('toggle-active1').children('.toggle-content1').slideDown( Number(elSpeed) );
            }

            element.children('.toggle-header1').off( 'click' ).on( 'click', function(){
                element.toggleClass('toggle-active1').children('.toggle-content1').slideToggle( Number(elSpeed) );
                return true;
            });
        });
